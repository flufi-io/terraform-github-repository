...
| <a name="input_environment_secrets"></a> [environment\_secrets](#input\_environment\_secrets) | Secrets to be stored in the repository for the environment | `map(string)` | `null` | no |
| <a name="input_environment_variables"></a> [environment\_variables](#input\_environment\_variables) | Variables to be stored in the repository for the environment | `map(string)` | `null` | no |
